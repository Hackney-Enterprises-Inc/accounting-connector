...
- **Modest total concurrency.** Xero allows this app 60 calls a minute and 5,000 a day against
  each connected organisation, none of it shared with the customer's other apps. The package's
